...
RSpec.describe CompleteAllItemsWorker, type: :job do
  ...
  let(:another_todo_list) { create(:todo_list) }
  let(:first_todo_item) { create(:todo_item, todo_list: todo_list, completed: false) }
  let(:second_todo_item) { create(:todo_item, todo_list: todo_list, completed: false) }
  let(:third_todo_item) { create(:todo_item, todo_list: todo_list, completed: false) }
  let(:another_list_item) { create(:todo_item, todo_list: another_todo_list, completed: false) }
